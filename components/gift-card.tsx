...
export function GiftCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative flex h-full flex-col justify-between p-4 sm:p-5',
      ...
      >
        ...
        <div className="space-y-0.5">
          <p
            className={cn(
              'text-[9px] font-medium tracking-[0.24em]',
        ...
        <div className="flex items-center justify-between">
          <span
            className={cn(
              'text-[8px] font-medium tracking-[0.22em]',
